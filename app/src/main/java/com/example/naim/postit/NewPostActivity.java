        ...
        newPostBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(desc) && postImageUri != null){
                    ...
                    image_path.putFile(postImageUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                        @Override
                        ...
                        public void onComplete(@NonNull final Task<Uri> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                final File newImageFile = new File(postImageUri.getPath());
                                ...
                                ref.putFile(postImageUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                    @Override
                                    public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task) throws Exception {
                                        if (!task.isSuccessful()) {
                                            throw task.getException();
                                    ...
                                    public void onComplete(@NonNull final Task<Uri> task) {
                                        ...
                                        final Uri thumbsUri;
                                        thumbsUri = task.getResult();
                                        if (task.isSuccessful()) {

                                            Map<String, Object> postMap = new HashMap<>();
                                            postMap.put("image_url", downloadUri.toString());
                                            postMap.put("image_thumb", thumbsUri.toString());
